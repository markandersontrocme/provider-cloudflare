...
PROJECT_REPO ?= github.com/markandersontrocme/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION ?= 4.24.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-cloudflare
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-cloudflare_v4.24.0
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/cloudflares/01-delete.yaml.tmpl.
